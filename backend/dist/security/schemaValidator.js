...
exports.RemoteSettingsSchema = Joi.object()
    .keys({
    host: Joi.string()
        .uri()
        .regex(/^(ws:\/\/|wss:\/\/)/)
...
exports.LoginSchema = Joi.object()
    ...
    .required();
exports.ErrorResponseSchema = Joi.object()
    .keys({
...
exports.RequestSchemaValidator = async (req, schema) => {
    return await exports.SchemaValidator(req.body, schema).catch((result) => {
        logger_1.logger.warn(`wrong scema data rrrived ` + `from ${exports.GetIp(req)}, error: ${result.error.message}`);
        const error = {
            responseCode: 2422,
