...
export class AuthenticationRouter {
  ...
  public routes(app: express.Express): void {
    app.route('/API/auth/login').post(async (req: Request, res: Response) => {
      let loginData: Login;
      try {
    ...
    app.route('/API/auth/login/tfa').post(async (req: Request, res: Response) => {
      let loginData: Login;
      try {
        loginData = await RequestSchemaValidator(req, LoginSchema);
      } catch {
    ...
    app.route('/API/auth/logout').post(async (req: Request, res: Response) => {
      /**
